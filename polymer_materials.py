#!/usr/bin/env python3
"""
Polymer Materials profit checker for Jita 4-4.
...
COMPONENT_RECIPES: Dict[str, Dict[str, Dict[str, int]]] = {
    ...
    "C3-FTM Acid": {
        "materials": {
            "Fullerite-C84": 100 / 100,
            "Fullerite-C540": 100 / 100,
            "Megacyte": 80 / 100,
            "Helium Fuel Block": 5 / 100,
        }
    },
    "Carbon-86 Epoxy Resin": {
        "materials": {
            "Fullerite-C32": 100 / 160,
            "Fullerite-C320": 100 / 160,
            "Zydrine": 30 / 160,
            "Nitrogen Fuel Block": 5 / 160,
        }
    },
    "Fullerene Intercalated Graphite": {
        "materials": {
            "Fullerite-C60": 100 / 120,
            "Fullerite-C70": 100 / 120,
            "Mexallon": 600 / 120,
            "Hydrogen Fuel Block": 5 / 120,
        }
    },
    "Fulleroferrocene": {
        "materials": {
            "Fullerite-C50": 200 / 1000,
            "Fullerite-C60": 100 / 1000,
            "Tritanium": 1000 / 1000,
            "Oxygen Fuel Block": 5 / 1000,
        }
    },
    "Graphene Nanoribbons": {
        "materials": {
            "Fullerite-C28": 100 / 120,
            "Fullerite-C32": 100 / 120,
            "Nocxium": 400 / 120,
            "Nitrogen Fuel Block": 5 / 120,
        }
    },
    "Lanthanum Metallofullerene": {
        "materials": {
            "Fullerite-C70": 100 / 120,
            "Fullerite-C84": 100 / 120,
            "Nocxium": 200 / 120,
            "Oxygen Fuel Block": 5 / 120,
        }
    },
    "Methanofullerene": {
        "materials": {
            "Fullerite-C70": 100 / 160,
            "Fullerite-C72": 100 / 160,
            "Isogen": 300 / 160,
            "Hydrogen Fuel Block": 5 / 160,
        }
    },
    "PPD Fullerene Fibers": {
        "materials": {
            "Fullerite-C50": 300 / 250,
            "Fullerite-C60": 100 / 250,
            "Pyerite": 800 / 250,
            "Hydrogen Fuel Block": 5 / 250,
        }
    },
    "Scandium Metallofullerene": {
        "materials": {
            "Fullerite-C72": 300 / 160,
            "Fullerite-C28": 100 / 160,
            "Zydrine": 25 / 160,
            "Helium Fuel Block": 5 / 160,
        }
    },
}
