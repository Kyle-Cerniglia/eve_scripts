#!/usr/bin/env python3
"""
Processed Moon Materials profit checker for Jita 4-4.
...
COMPONENT_RECIPES: Dict[str, Dict[str, Dict[str, int]]] = {
    ...
    "Caesarium Cadmide": {
        "materials": {
            "Cadmium": 100 / 200,
            "Caesium": 100 / 200,
            "Oxygen Fuel Block": 5 / 200,
        }
    },
    "Carbon Fiber": {
        "materials": {
            "Hydrocarbons": 1000 / 2000,
            "Evaporite Deposits": 1000 / 2000,
            "Hydrogen Fuel Block": 50 / 2000,
        }
    },
    "Carbon Polymers": {
        "materials": {
    ...
    "Ceramic Powder": {
        "materials": {
            "Evaporite Deposits": 100 / 200,
            "Silicates": 100 / 200,
            "Hydrogen Fuel Block": 5 / 200,
        }
    },
    "Crystallite Alloy": {
        "materials": {
    ...
    "Oxy-Organic Solvents": {
        "materials": {
            "Hydrocarbons": 2000 / 10,
            "Atmospheric Gases": 2000 / 10,
            "Oxygen Fuel Block": 5 / 10,
        }
    },
    "Platinum Technite": {
        "materials": {
...
def main():
    ...
    header_component = "Proc Moon Mats"
